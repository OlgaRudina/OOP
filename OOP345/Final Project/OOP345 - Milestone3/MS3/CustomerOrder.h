...
class CustomerOrder
{
	...
	unsigned int ItemCount; //nOrders
	ItemInfo** ItemList; //order
...
public:
	...
	CustomerOrder(CustomerOrder& customerOrder) { throw "ERROR:  Copy is not allows"; };			//should throw an exception if called
